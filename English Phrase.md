# 《The unlikely pilgrimage of Harold Fry /Rachel Joyce 一个人的朝圣/蕾秋·乔伊斯》
## Day01(5)
- take up : 继续、把...接着进行下去
- as if : 好像
- good Lord : 天哪
...
- setout : 动身、出发
- long for sth : 渴望...
- let alone : (用于否定句后表示强调)当然不会、更不用说
- be nothing to do with : 与...毫不相干
- out of breath : 喘不过气、上气不接下气
## Day12(2)
- cling to : 紧贴
- take off : 脱下、脱去(衣服)
## Day13(5)
- clean sth out : 把(房间、屋子等的内部) 打扫干净
- all year round : 全年
- set off : 出发、启程
- reach for : 伸手(或臂)去拿
- borush sth off : (用手或刷子)把...刷干净、把...掸净、刷掉、掸去
## Day14(3)
- stick out : 突出
- in danger of : 处于...危险之中
- accuse sb of (doing) sth : 控告、指责某人(做)某事
## Day15(4)
- lean against : 斜倚着、靠着
- fetch sb sth : 给某人拿来某物
- intrude on : 闯入、侵扰
- help oneself (to sth) : 自己取(食物等)
## Day16(5)
- deal with sth : 对付、应付、处理
- be used to (doing) sth : 习惯于(做)某事
- catch (sb) up : 赶上(某人)
- either way : 无论是(两者中的)哪种情况、(两种情况)无论何者为实
- set out : 动身、出发
## Day17(3)
- start in : 开始(努力做某事)
- on one's feet : 站着
- one after another : 相继、一个接一个
## Day18(2)
...
- do the ironing : 熨衣服
- set eyes on sb/sth : 看见、看到
- check into : 登记入住(旅馆或私立医院)
## Day24(4)
- all along : 一直、从一开始
- work out : 计算出、解出(数学题答案)
- pull a face : 做怪相、扮鬼脸
- hang up : 挂断电话
## Day25(3)
- to the accompaniment of sth : 在...的伴奏下
- switch off : 关掉、关上(电灯等)
...
- one another : 互相、彼此
## Day35(1)
- be prone to sth : 易于遭受(疾病)的、有(消极)倾向的
## Day36(3)
- end up : 最后(处于)、最后(成为)、(以...)告终
- on site : 在(工厂、办公楼等的)内部
- keep an eye on : 看管、监视、密切注意
## Day37(3)
- in case : 以防万一
- in anger : 发怒
- hang up : 挂断(电话)/突然挂断...的电话
## Day38(2)
- used to : 过去经常(一直)发生
- catch one's eye : 引起(某人)的注意、吸引(某人)的目光
## Day39(4)
- give up : 投降、认输、放弃
- stick out : 探出、露出、凸出
- so that : (引出结果)因此、所以
- bon voyage : 一路平安、旅途愉快
## Day40(1)
- think of sth/sb : 记得、想起
## Day41(10)
- on top of : 在...上面、在...上方、覆盖着
- in one piece : 完好的(地)、未受伤的(地)、未损环的(地)、平安无恙的(地)
- belong to sb : 属于某人、归某人所有
- wait for : 等待...、等着...
- come over : (通常远距离地)从...到、从...来
- as well : 也、又、还
- as soon as : 一...就
- give up : 投降、认输、放弃
- to one's surprise : 使某人惊讶的是
- steal a glance at : 偷偷地看一眼、偷瞥
## Day42(1)
- take care of : 照顾、照料、爱护、小心
## Day43(3)
- so as to : 为了
- can't help but do sth : 某人忍不住做某事、某人不能停止做某事
- catch sight of : (突然或刹那间)看见、发现
## Day44(2)
- catch sb's eye : 引起(某人)的注意、吸引(某人)的目光
- hold sth back : 隐瞒、不透露(情況)
## Day45(4)
- prune back sth back : 修剪(树枝)
- on the NHS : 由国民保健制度支付
- pick up : 拿起、提起、拾起、捡起
- put on : 穿、戴、涂、抹
## Day46(3)
- take pleasure in : 以...为乐事
- point out : 指出、说出(事实或错误)
- right away : 毫不迟疑、立刻
## Day47(2)
- good heavens : (表示惊讶或强调)天哪
- no wonder : 难怪、怪不得、不足为怪
## Day48(4)
- hold sth out : 伸出手(或絡膊)、递出东西
- be in love : 在恋爱、相爱
- catch sb's eye : 引起某人注意、惹人注目
- bring sth on : 使发展、导致(通常指坏事)
## Day49(6)
- pass through : 经过、路过
- as well as : 除...之外、也、还
- once in a while : 偶尔、有时、间或
- give up : 放弃(某物的所有权或使用权)、交出、让出
- along with : 与某人/某物一起
- make way for : 让...通过、给...让路、让出位置
## Day50(2)
- be on the trail of : (循线索)追踪
- make up sth : 形成、组成、构成
## Day51(2)
- get up : (使)起床
- face to face (with sb) : (与某人)面对面
## Day52(3)
- in truth : (强调真实情况)的确、事实上
- used to : 过去经常(一直)发生
- on the spot : 当场、当下
## Day53(3)
- due to : 由于、因为
- state-of-the-art : 应用最先进技术(或方法)的、最先进的
- in a hurry : 匆忙、急急忙忙
## Day54(3)
- remind sb of sb/sth : 使(某人)想起
- make one's way : 行进(尤指艰难地、或需要很长时间时)
- for instance : 例如
## Day55(2)
- be filled with sth : 充满某物
- on vacation : 在度假
## Day56(2)
- reach for : 伸手(或臂)去拿
...
- after all : 毕竟、终归
## Day61(5)
- at least : 毕竟(用于给反面情况加上正面评价)
- no longer : 不再、不复
- in time for : 来得及、及时
- as to sth : 关于、至于
- walk out : 遗弃、抛弃、舍弃、离开(某人)
## Day62(1)
- give up : 投降、认输、放弃
## Day63(3)
- catch one's eye : 引起(某人)的注意、吸引(某人)的目光
- be made (out) of sth : 由...制成
- ease up : 放松、松懈
## Day64(4)
- in remission : (疾病的)减轻、缓和
- in return : 作为交换、作为回报
- in order to : 为了、以便
- give away : 赠送、捐赠
## Day65(4)
...
- shagged out : 疲惫不堪的、精疲力竭的
## Day66(4)
- put sth down : 搁在(桌子上等)、放下
- come on : (状态，情况)开始、来到、发生
- come at sb : 扑向(某人)
- get up : (使)起床
## Day67(5)
- in love with : 对.倾心、爱慕、热恋
- all the time : 经常、总是、老是
- get used to : 开始习惯于
- after all : 毕竟、终归
- give up : 投降、认输、放弃
## Day68(1)
- keep up : (与...)齐步前进、并驾齐驱、跟上
## Day69(4)
- drive on : 驱车继续行驶
- side by side : 并排、并肩地
- look after : 照顾、照看
...
## Day71(5)
- later on : 过后、以后、将来
- have no objection to sth : 对某事没有异议
- apart from : 除...外(尚有)、此外
- cry out : (因伤痛、害怕、惊讶等)大叫、叫喊
- watch over : 保护、照看
## Day72(7)
- surrender to sth : 听任某事物摆布、屈服于某事物
- point out : 指出、说出(事实或错误)
- from a distance : 从远处、自远处
- at atime : 每次、逐一、依次
- hunker down : 蹲、蹲坐、蹲下
- one another : 互相
- in turn : 继而、转而、反过来
## Day73(6)
- leave sb/sth behind : (永久地)离开、脱离与...的联系
- be short for : 是某事物的简称
- freshen up : 梳洗
- make one's way : 行进(尤指艰难地、或需要很长时间)
- have a problem with sb : 认为...令人讨厌(或无礼)
- seek sb/sth out : 找出、找到
## Day74(7)
- no longer : 不再、不复
- put up : 建造、搭建、设置
- in return : 作为回应
- after all : 毕竟、终归
- let sb down : 不能帮助、不能支持(某人)；使失望
- give up : 投降、认输、放弃
- instead of : 代替...、而不是...
## Day75(1)
- be in touch with sb : (与...)有(或进行、保持等)联系
## Day76(1)
- once more : 再次回到(从前的状态)
## Day77(3)
- as well as sth/sb : 除...之外、也、还
- no more than : 最多、不超过、仅仅
- put sth on : 穿上、戴上
## Day78(1)
- fit sb/sth in : 安插、找地方放、把...放进
## Day79(4)
- side by side : 并排、并肩地
- in a flash : 转瞬、一瞬间
...
- all along : 一直、自始自终
## Day80(4)
- take pleasure in : 喜欢做某事、乐于、领略玩赏、喜欢
- accuse (sb) of : 控告、控诉、谴责
- in light of : 考虑到、鉴于
- remind (sb) of : 提醒、使想起
## Day81(5)
- get into : 被录取、被接受入学
- in awe of sb : 对某人非常崇敬(敬畏)
- do sb a favour : 帮(某人)忙、帮助(某人)
- in tears : 泪汪汪地、流着泪、哭着
- mop sth/sb up : (尤指为清洁某一表面)擦干、抹去(液体)
## Day82(5)
- burst out : 突然爆发(某种感情)
- take place : 发生、举行
- look after : 照顾、照料、照管
- apart from : 除了...外(都)、要不是
- be in touch : (与...)有(或进行、保持等)联系
## Day83(3)
- screw sth up : 搞糟、搅乱、弄坏
- hand in hand : 手拉手
- for heaven's sake : (用于加强请求、疑问的语气或表示厌烦、恼怒)看在上帝份上、天哪、行行好、拜托
## Day84(3)
- be filled with : (使)充满、装满、注满、填满
- rob sb of : 抢劫、掠夺、盗取
- in defiance of : 违抗、拒绝服从
## Day85(6)
- make a mess of (doing) sth : 把(做)某事搞得一塌糊涂
- pass through : 经历、遭受
- catch sight of : (突然或刹那间)看见、发现
- be about to do sth : 即将(马上)做某事
- call for sth : 需要
- no more than : 只不过、仅仅
## Day86(3)
- a intake of breath : 吸一口气
- rein in : 控制、约束
- be about to : 即将、行将、正要(做某事)
## Day87(5)
- check into : 登记入住(旅馆或私立医院)
- on sb's behalf : 因为某人、为了某人
- once more : 有一次、再次
- look out for sth : 努力寻找、注意寻找
- give in to sth : 克服、屈服于
## Day88(4)
- flare up : 复发、突然加剧
- screw up : (因光线太强或疼痛等)眯起眼睛
- plod on : 艰难地行走、吃力地行进
- cry out : 大声呼喊
## Day89(3)
- nothing like : 完全不像、根本不像
- on one's behalf : 因为某人、为了某人
- have no idea : 丝毫不知道
## Day90(4)
- start off : 进行(或开展)起来
- break into : 强行进入、闯入
...
- measure up : 测量、度量
- runner bean : 红花菜豆
- hang about : (在某个地方)闲呆、闲荡
- out of place : 不在适当(通常)的位置上
- bunch up : (使)集中、(使)挤在一起
- run out : 用完、耗尽(某物)
- go by : (时间)过去
## Day92(6)
- get hold of sb : 找到(某人)、得到
- ask for sb : 说要找(某人)
- break into : (尤指为盗窃目的)破门而入
- clear away : 清除
- nothing other than : 只有...、除...外没有
- make no difference : 对某人(或某个环境)没有影响
## Day93(2)
- set up : 创建、建立、安排、组建
- duct tape : (用于黏合物品或粘贴漏洞的)强力胶带
## Day94(3)
- there is no doing sth : 不可能、无法(做某事)
...
- hang up : 悬挂、吊
- look for : 寻找
- meet with : 经历、体验(不愉快的事)
## Day96(2)
- funeral director : 丧葬承办人、殡仪员
- make a/the difference : 有作用、有影响
## Day97(4)
- come in : (潮水)上涨、涨潮
- stick with sth : 持续、坚持
- take shape : 成形、形成
- screw up one's eyes : 眯起眼睛
## Day98(3)
- turn to : 使改変、便変成
- call for : 需要、要求
- fill with : (使)充满、装满、注满、填满
## Day99(3)
- let sth go : 放开、释放
- be under way : 已经开始
- slip away : 溜出去、悄悄离开
...
- nothing but : 只有、只是
- let go : 放手、松开
# 《Great Expectations /Charles Dickens 远大前程/查尔斯·狄更斯》
## Day 01(9)
...
- become aware of : 发觉、知道
- on the occasion of : 在(重要事件)之际
- put up : 将...收起、把...放回原处
- set sth aside : 把...放到一边(或搁到一边)
- carry out : 履行、执行、落实
- stand in sb's way : 阻止某人
## Day17(15)
- glance at : 浏览、粗略地看
- be lost in sth : 沉浸于、全神贯注
- return to sth : 再讨论、重新处理
- instruct sb to do : 命令某人做某事、指示某人做某事
- communicate sth to sb : 与某人通、与某人交流信息
- come into : 继承(遗产)
...
## Day19(9)
- take...to be sth : 认为、把...看作
- be parted from : 和...分离
- take a turn : 转一圈
- for some reason or other : 由于某种原因
- put out : 熄灭
- pay one's visit to sb : 拜访某人
- fall short of : 达不到
- out of place : 不得体
- on account of : 由于，因为
## Day20(5)
- take leave of... : 向...告别
- at  (one's)ease : 无拘无束、自由自在
- occur to sb. : (主意或想法突然)浮现于脑中
- be ashamed of... : 对...感到羞耻、对...感到羞愧
- break out : 突然爆发
## Day21(8)
- to tell the truth : 老实说、说实话
- at length : 终于
- rub off : 使...磨擦掉
- make a deep impression on sb : 给某人留下了深刻的印象
- address oneself to... : 着手....、忙于...、投入...
- no more than : 不过、仅仅
- throw up : 放弃
- fall back : 后退
## Day22(10)
- but for : 倘若没有、要不是
- once for all : 仅此一次
- be in good hands : 正在妥善处理中
- make an example of : 用某人来杀一儆百
- slip through sb's fingers : (机会或某人)被错过
- not by any means : 一点也不、绝不
- paint sth over : 用新的颜料覆盖...的画面(表面)
- at sb's expense : 由某人付钱、由某人负担费用
- and so forth : 等等
- give sb credit for : 为...而称赞某人
## Day23(9)
- fall back : (因惊奇、恐惧等)后退、退却
- take a fancy to sb / sth : 爱上、喜欢上(常指没有明显原因)
- at all events : 不管是哪种情况、无论如何
- come out of : 从(坏的情况中)走出
- provide for sb : 供养、抚养
- to the last degree : 极度地、非常地
- inability to do : 无能做...、不能做...
- lay stress on : 强调、把重点放在...上
- at a loss : 不知所措、困惑
## Day24(10)
- at heart : 本质上、实际上
...
- in one's presence : 在...面前、有...在场
- strike in : 插嘴
- break sth off : (突然)终止、結束
- piece sth out : 把...串连起来
- come upon sb : (某种感觉)向某人袭来
## Day25(9)
- buy up : 大量买进、全部买下
- on one's own account : 靠自己、为自己
- in keep with : 与...一致
- correspond to sth : 与...相一致
- get on famously : 相处极好
- go to church : 做礼拜
- apply oneself to sth : 努力、专心致志于某事
- stick to sth : 坚持做某事
- fall to sth : 开始做某事
## Day26(10)
- remove...from... : 把...从...移开
- in suspense : 在悬念中、悬而未决
...
- more than enough : 太、过于
- talk down to sb : 用高人一等的口气对某人说话
- behave with sb : 与某人相处的方式
- go through one's mind : 浮现在某人脑海里
## Day28(8)
...
## Day29(11)
- refer to : 查阅、参考
- make an appointment : 约定、预约
- distinguish between A and B 区分、辨别A和B
- look in the face : 正视...、直视...
- look into : 调查、审查
- stare sb down : 盯得某人不敢对视
- come to sth : 总计为、加起来是
- establish a reputation : 确立声誉
- run into sth : 遇到(困难等)
- get on : (尤指中断后)继续做某事
- depart this life : 离开人世、去世、亡故
## Day30(7)
- be conscious of : 意识到
- close in : (夜幕)降临
- settle down : 安定下来
- come out of sth : 从(坏的情况中)走出
- by degrees : 逐渐地、渐渐地
- do sb an injustice :待...不公正、冤枉
- no more than : 仅仅、只不过
## Day31(9)
- regardless of : 不管、不顾
- come of age : 到达法定年龄、成年
- a crowd of : 一大堆、许多的
- mark the occasion : 庆祝这一特别时刻
- take care to do sth : 特意做某事
- at a disadvantage : 处于劣势
- blow one's nose : 擤鼻子
- set sth aside : 暂时不考虑
- cast about for : 苦苦思索、拼命寻找
## Day32(7)
- get sth out of sb : 从某人那里探听到，劝说某人说出
- take sb into one's confidence : 对某人吐露真情，把某人当成心腹
- as to : 至于、关于
- coming of age : 成年、成熟
- hold back : 抑制
- do good to : 对...有好处、对...有益
- for certain : 肯定地、确凿地
## Day33(9)
- no doubt : 无疑、必定
- all sorts of : 各种各样的
- press...upon... : 把...强加于...
- put sb at a disadvantage : 让某人处于劣势、使某人吃亏
- the next day but one : 第三天
- at any rate : 无论如何
- take pleasure in : 以...为乐、喜欢...
- be tired of : 厌倦
- in short : 总之、简言之
## Day34(8)
- take sb in : 收留、留宿、收养
- be at sb's command : 听候某人的吩咐、服从某人的支配
- be inseparable from sth : 与某事不可分离、分不开的
- keep out : 不许入内、挡在外面
- spread sth out : 将...分散、将某物抛开(展开)
- no sooner... than : — ...就...
- attend to sb : 关心某人、照顾某人
- be unfaithful to : 对...不忠
## Day35(7)
- argument between A and B : A和B之间的争吵
- speak to sb about sth : 为某事数说某人
- take sth (from sb) : 夺取、控制
- be meant to do : 理应发生、应该
- throw away : 浪费、白费、错过
- have an effect on sb : 对某人产生作用
- day after day : 一天又一天
## Day36(8)
- make out : 勉强看清
- hold out : 伸出
- respond to sth : 做出回应
- explain oneself : 为自己的行为作说明(或解释)
- in the least : 丝毫、一点儿
- on the contrary : 与此相反
- keep off : 不接近某人
- mend one's way of life : 改过自新
## Day37(9)
- up to : 直到
- have no intention of doing sth : 无意做某事
- make so bold as to do sth : 斗胆(冒昧)做某事
- flash on sb : 突然意识到、猛然领悟
- a flood of : 大量、大批(的人或事物)
- put away : 积攒
- one grain of : —丝、一点儿
- rise up : 高耸
- not that : 并非、并不是说
...
## Day39(7)
- ask for sb : 要求见某人
- bring oneself to do : 使自己做...
- give out : 公布、宣布
- take one's seat : 就坐
- put on trial : 受审、经受考验
- hold out both one's hands : 伸出某人的双手
- in return : 作为回报
## Day40(8)
- settle down to : 开始认真对待、定下心来做
- be chained to sth : 受到某事的束缚
- keep (sb) out of sth. : (使)坚持(避免或不卷入)
- forget oneself : 忘乎所以、行为(言谈)失态(不得体)
- for good : 永远、永久
- by no means : 决不、一点也不
- win sb over : 说服某人、把某人争取过来
- take a room : 定一个房间、租一个房间
## Day41(7)
- have no hope of : 对...毫无希望
- be unknown to sb : 不为某人所知的
- be responsible for : 应对...承担责任、对(尤指坏事)负责任
- on behalf of : 代表
...
## Day43(9)
- take up : 打断
- be that as it may : 就算这样
- lead sb on : 使误信、误导某人
- for God's sake : 看在上帝的份上
- false and base : 虚伪和卑鄙
- do sb a service : 帮某人的忙
- without one's knowledge :在某人不知道的情况下
- hold back from doing sth : 抑制住做某事
- in answer to : 回应
## Day44(8)
- for one's sake : 为了...缘故、看在...份上
- put aside : 放在一边
- blame...for... : 因为...而责备...
- in despair : 绝望地
- get sb out of one's thoughts : 忘记某人
...
# 《Oliver Twist /Charles Dickens 雾都孤儿/查尔斯·狄更斯》
## Day61(7)
...
# 《Death on the Nile /Agatha Christie 尼罗河上的惨案/阿加莎·克里斯蒂》
## Day01(5)
- pull sth down : 拆毁某物、拆掉某物
- put someone through : 为...接通电话
